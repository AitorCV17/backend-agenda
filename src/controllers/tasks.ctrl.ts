// src/controllers/tasks.ctrl.ts
import { Request, Response } from "express";
import { createTask, getTasks, getTask, updateTask, deleteTask } from "../services/task.srv";

export const createTaskCtrl = async (req: Request, res: Response): Promise<void> => {
  try {
...
export const getTasksCtrl = async (req: Request, res: Response): Promise<void> => {
  try {
...
export const getTaskCtrl = async (req: Request, res: Response): Promise<void> => {
  try {
    const { id } = req.params;
    const { userId } = req.body;
...
export const updateTaskCtrl = async (req: Request, res: Response): Promise<void> => {
  try {
...
export const deleteTaskCtrl = async (req: Request, res: Response): Promise<void> => {
  try {
    const { id } = req.params;
    const { userId } = req.body;
